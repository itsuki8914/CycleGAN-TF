...
def main():
    ...
    for i in range(100001):
        ...
        if i %100 ==0:
            ...
            batch_images_a  = vlgenA.getBatch(1,id)
            id = np.random.choice(range(vlenB),1)
            batch_images_b  = vlgenB.getBatch(1,id)
            ...
            ax.plot(da_hist,label="disA_loss", linewidth = 0.25)
            ax.plot(db_hist,label="disB_loss", linewidth = 0.25)
